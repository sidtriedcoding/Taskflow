...
CREATE TABLE "_TeamProjectTasks" (
    ...
    CONSTRAINT "_TeamProjectTasks_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- AddForeignKey
ALTER TABLE "_TeamProjectTasks" ADD CONSTRAINT "_TeamProjectTasks_A_fkey" FOREIGN KEY ("A") REFERENCES "Task"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_TeamProjectTasks" ADD CONSTRAINT "_TeamProjectTasks_B_fkey" FOREIGN KEY ("B") REFERENCES "Team"("id") ON DELETE CASCADE ON UPDATE CASCADE;
