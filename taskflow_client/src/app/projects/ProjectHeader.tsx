...
// Remove the duplicate TabButton definition

const ProjectHeader = ({ name, activeTab, setActiveTab }: ProjectHeaderProps) => {
      ...
      <div className='flex flex-wrap-reverse gap-2 border-y border-gray-200 pb-[8px] pt-2 dark:border-stroke-dark md:items-center'>
        <div className='flex flex-1 items-center gap-2 md:gap-4'>
          <TabButton
            ...
            activeTab={activeTab} // Pass activeTab to TabButton
          />
          <TabButton
            name="List"
